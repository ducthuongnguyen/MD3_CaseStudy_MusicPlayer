                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="namePlaylist" id="namePlaylist" placeholder="namePlaylist">
                                </div>
                                <br>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="typeId" id="typeId" placeholder="typeId">
                                </div>
                            </div>
                            <br>
                            <div class="col-md-6 col-lg-4">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="songQuantity" id="songQuantity" placeholder="songQuantity">
                                </div>
                            </div>
                            <br>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="view" id="view" placeholder="view">
                                </div>
                            </div>
                            <br>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="userId" id="userId" placeholder="userId">
                                </div>
                            </div>
                            <br></div><div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="songId" id="songId" placeholder="songId">
                                </div>
                            </div>
